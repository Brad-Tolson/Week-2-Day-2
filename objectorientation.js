...
let Batman = new Cat('Batman', 6, 'black')
console.log(Batman)
...
let Brad = new Wizard('Brad', 9000, 'Fireball')
Brad.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
let apple = new Phone('apple', '1', 2, 'red', 100)
let pear = new Phone('pear', '2', 3, 'blue', 1000)
let orange = new Phone('apple', '3', 4, 'orange', 10000)
/* 
...
let car1 = new Vehicle(4, "red", 100,)
/* 
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'green', 30000, 'Taco Bell', true)
/*
...
//Code Here
let myFirstBoat = new Boat(8, 'white', 10000, 'boat boat', 'pontoon', false)
/*
